			...
			<div className="therapy-info-container">
				<div className="therapy-info-container1">
					<div className="therapy-section">
						...
						<p className="innovative-path-description">В группе можно научиться видеть и слышать себя шире и многограннее <br/><br/>

В группе можно проявлять себя в безопасной атмосфере<br/><br/>

В группе можно получить больше поддержки и откликов на ваши сложности<br/><br/>

В группе глубоко и тепло проживать разные чувства, делиться печалями и радостями<br/><br/>
